...
| Wall migrations           | Testimonial.to, Senja, Famewall, Endorsal, Trustmary, Trust, Shoutout, Feedspace, Boast, Vocal Video, WiserReview, Shapo, Walls.io, Taggbox, EmbedSocial | Testimonial.to, Senja, and Famewall have explicit profiles; every other wall is manual/spreadsheet-only until its retrieval policy and deletion lifecycle are implemented                         |
