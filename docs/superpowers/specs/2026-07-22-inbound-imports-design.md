...
| Connected social          | X, LinkedIn                                                                                                                                                                                                          | Clerk OAuth plus official APIs; source-specific access limits are shown          |
| Connected reviews         | Google Business Profile, YouTube comments                                                                                                                                                                            | Clerk Google OAuth plus official APIs                                            |
| Public social/community   | Product Hunt, Reddit, Vimeo                                                                                                                                                                                          | Public structured-page import where the page is accessible                       |
| Public review/app sources | Capterra, G2, Apple App Store, Google Play, Trustpilot, Shopify, Yelp, Apple Podcasts, AppSumo, Zillow, Udemy, Chrome Web Store, Skillshare, Realtor.com, SourceForge, Whop, WordPress, Fiverr, HomeStars, Goodreads | Structured data/Open Graph extraction with per-domain allow policy               |
| Wall migrations           | Testimonial.to, Senja, Famewall, Endorsal, Trustmary, Trust, Shoutout, Feedspace, Boast, Vocal Video, WiserReview, Shapo, Walls.io, Taggbox, EmbedSocial                                                             | Public wall URL or provider CSV; provider profile over the common wall extractor |
...
The public importer accepts only `http` or `https` URLs and applies all of the following:
