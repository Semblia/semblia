...
| `docs/plans/2026-05-03-v1-auth-integrations-agent-access-implementation-plan.md` | Current implementation plan for Clerk org tenancy, project credentials, outbound integrations, and agent-native access. | Use after continuity docs when starting the next implementation phase. |
