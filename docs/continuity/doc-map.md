...
| `docs/plans/2026-05-03-v1-auth-integrations-agent-access-implementation-plan.md` | Current implementation plan for Clerk org tenancy, project credentials, outbound integrations, native integrations, and agent-native access. | Tasks 1 through 5 are implemented; use after continuity docs when starting Task 6 agent access/MCP. |
