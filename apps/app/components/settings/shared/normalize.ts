 ...
 * `apps/api/src/modules/projects/projects.dto.ts`, which requires the slug to
 ...
 * `apps/api/src/modules/public-surfaces/public-hostname.ts`; keep the two in
 ...
 * `apps/api/src/modules/projects/projects.dto.ts`. Returns an error string,
