      ...
      <div className="space-y-8">
        ...
        <Demo label="Button Group">
          ...
          <ButtonGroup>
            ...
            <Button variant="outline"><AlignCenter /></Button>
            <Button variant="outline"><AlignRight /></Button>
          </ButtonGroup>
        </Demo>
      </div>
    </Section>
...
export function BadgesSection() {
  return (
    <Section id="badges" title="Badge" description="Label and status indicators.">
      <Demo label="Variants">
...
export function AlertsSection() {
  return (
    <Section id="alerts" title="Alert" description="Contextual feedback and notification messages.">
...
export function AvatarsSection() {
  return (
    <Section id="avatars" title="Avatar" description="User profile images with fallback and group support.">
      <div className="space-y-8">
        <Demo label="Sizes">
...
export function CardsSection() {
  return (
    <Section id="cards" title="Card" description="Container cards with header, content, footer, and action areas.">
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Cards are the fundamental surface for grouping related information together.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">Footer is great for actions or metadata.</p>
          </CardContent>
        ...
        <Card size="sm">
          <CardHeader>
            ...
            <CardDescription>size=&ldquo;sm&rdquo; reduces internal padding.</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">Compact cards for dense UIs.</p>
          </CardContent>
        </Card>
      </div>
    </Section>
