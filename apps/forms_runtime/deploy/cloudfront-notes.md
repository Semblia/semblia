...
CloudFront terminates TLS for `*.collect.semblia.com` and forwards requests to the Lambda Function URL origin.
...
- Do not cache `POST`.
- Forward request body, `content-type`, and `x-semblia-original-host`.
